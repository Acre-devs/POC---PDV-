...
namespace PdvLocal.AgenteCaixa.Data;

public class AgenteCaixaDbContext : DbContext
{
    public AgenteCaixaDbContext(DbContextOptions<AgenteCaixaDbContext> options) : base(options)
    {
    }
